        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
            {
                totalPages === 0 ?
                    <div>
                        <span>No monitors created yet!</span>
                    </div>
                    :
                    <>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between border-t border-slate-800 bg-slate-800/30">
                            ...
                            <div className="flex gap-1.5">
                                <button
                                    ...
                                    className="px-3 disabled:hidden py-1.5 rounded-lg border border-slate-700 text-sm font-medium text-slate-600 disabled:cursor-not-allowed cursor-pointer">
                                    Previous
                                </button>
                                {
